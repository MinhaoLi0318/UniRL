...
| [`sensenova_u1/`](sensenova_u1/) | `sensenova/SenseNova-U1.5-8B-MoT-Preview` | Text → Image (pixel flow) | `train_diffusion` | trainside | [`sensenova_u1_5_trainside`](../../examples/diffusion/sensenova_u1_5/sensenova_u1_5_trainside.yaml), [`sensenova_u1_5_ocr_trainside_lora_4x8`](../../examples/diffusion/sensenova_u1_5/sensenova_u1_5_ocr_trainside_lora_4x8.yaml) | engine-specific (trainside only); `*_4x8` recipes: multi-node, scorer-dependent (`ocr`); recipe dir is `sensenova_u1_5/`, package is `sensenova_u1/` | ✅ |
